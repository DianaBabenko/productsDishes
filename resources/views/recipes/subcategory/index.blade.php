            ...
            <div class="col-12">
                <div class="">
                    <div class="header-div row justify-content-center shadow-sm radius-div mx-auto" style="width: 40%;">
                        <h3 class="mt-2">Subcategory: {{ $subcategory->name}}</h3>
                    </div>
                    <a class="radius-div main-div col-1 btn btn-outline-lavand" href="{{route('recipes.index')}}"><- Back</a>
                        ...
                        @foreach($recipes as $count => $recipe)
                            ...
                            <div class="row mx-3 py-3 px-2 main-div radius-div mb-3">
                                <div class="row col-12 ml-1">
                                    <h4>
                                        <a href="{{ route('recipes.subcategory.show', [$subcategory->id, $recipe->id]) }}">{{$recipe->name}}</a>
                                    </h4>
                                </div>
                                <div class="row ml-2">
                                    {{$recipe->description}}
